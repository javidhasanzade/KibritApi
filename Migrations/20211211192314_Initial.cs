        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AppUserId = table.Column<string>(type: "varchar(85)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    AuthorsId = table.Column<string>(type: "varchar(40)", nullable: false),
                    BooksId = table.Column<string>(type: "varchar(40)", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    BooksId = table.Column<string>(type: "varchar(40)", nullable: false),
                    GenresId = table.Column<string>(type: "varchar(40)", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.InsertData(
                table: "Authors",
                columns: new[] { "Id", "Name" },
                values: new object[] { "e4ebc892-b222-4475-bd4b-73f5e69d96e5", "TestAuthor" });

            migrationBuilder.InsertData(
                table: "Genres",
                columns: new[] { "Id", "Name" },
                values: new object[] { "bda7d551-7e0e-4f0a-9da1-5b1600b18eb0", "TestGenre" });
